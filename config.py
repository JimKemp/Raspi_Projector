...
# VLC video output module.
#   None    -> let VLC auto-detect (correct when running under a desktop/X11)
#   "mmal_vout" -> hardware-accelerated output on older Pi OS (Pi 3/4, legacy stack)
#   "gles2" or "drm" -> options on newer Pi OS console/KMS setups
# For a CONSOLE-ONLY (no desktop) Pi, set this. "gles2" is a good first try on
# current Raspberry Pi OS; if video is black or stuttery, try "drm" then
# "mmal_vout". See README "Console-only mode".
VLC_VOUT = None
